...
- I didn't want to deploy anything to the cloud for a take home so kept everything local.
...
- If I were to build this for a real production system, I would have integrated with a message queue such as SQS.
